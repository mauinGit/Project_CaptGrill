...
class MainIngredientResource extends Resource
{
    protected static ?string $model = Ingredient::class;

    protected static string|UnitEnum|null $navigationGroup = 'Bahan Penjualan';

    protected static ?string $navigationLabel = 'Bahan Utama';
