...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bitter:wght@600&family=Inter:wght@400;500;600;700&display=swap"
        rel="stylesheet">
    <style>
        body {
...
<body
    class="bg-gradient-to-br from-[#1A5939] via-[#165032] to-[#0f3a24] min-h-screen flex items-center justify-center p-4 bg-pattern">
    <!-- Decorative Elements -->
    ...
    <div class="login-container w-full max-w-md rounded-3xl shadow-2xl p-8 md:p-12 relative z-10 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            <div class="flex justify-center mb-6">
                <div
                    class="w-56 h-24 flex items-center justify-center transform hover:scale-105 transition-transform duration-300">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePassword()"
                        ...
                        <!-- Mata tertutup -->
                        <svg id="eye-closed" class="w-5 h-5 block" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-3.5-10-8
                1-.5 2-.875 3-1m3-1a4 4 0 016 0m3 1c1 .125 2 .5 3 1-.5 2.5-2 4.5-4 5.75M3 3l18 18" />
                        </svg>
